...
def train_one_epoch_only(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for image_feats, prompt_feats, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        outputs = model(image_feats, prompt_feats) #ZladWu todo outputs:
        ...
        #防止内存泄漏
        del image_feats, prompt_feats, targets, outputs, loss_dict, loss_dict_reduced, loss_dict_reduced_unscaled, loss_dict_reduced_scaled, losses_reduced_scaled, losses, loss_value
