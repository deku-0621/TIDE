...
if __name__ == '__main__':
    ...
    iter_num = 1
    assert iter_num>0
    model_path= './train_output/best.pth'
    dino = get_dino_feat_fetcher()
    swin = get_swin_feat_fetcher()
    POS_THRE = 0.9
    NEG_THRE = 0.2
    test = False
    SOURCE = 'rtsp://admin:admin@192.168.0.100:8554/live'
    crop = False
    ...
    if crop:
        ...
        p4 = cv2.resize(p1,(224,224))
        # p5 = cv2.resize(p2,(224,224))
        # p6 = cv2.resize(p3,(224,224))
        p7 = cv2.resize(p1,(112,112))
